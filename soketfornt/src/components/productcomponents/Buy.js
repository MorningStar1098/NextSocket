...
const Buy = () => {
  ...
  useEffect(() => {
    axios
      .get(`${LIVE_URL}/api/products/getproduct/${id}`)
      .then((response) => {
        setShowsingleproduct(response.data.product);
      });
  }, [id]);
console.log("showsingleproduct",showsingleproduct);
...
console.log(body,"body")
    try {
      const response = await axios.post(
        `${LIVE_URL}/api/products/paywithproduct/${id}`,
        body,
        {
                  ...
                  <TableRow>
                    ...
                    <div>
                      <TableRow>
                        <TableCell>
                          <Typography>
                            TITLE:-{showsingleproduct?.PRO_NAME}
                          </Typography>
                        </TableCell>
                      </TableRow>
                      <TableRow>
