...
import { paymentproduct } from "../redux/actions/Actions";
const Payment = () => {
  const Navigate = useNavigate();
  const checkout = useSelector((state) => state?.checkoutdata?.checkoutproductsarr);
  ...
  return (
    <div>
      <TableContainer className={style.background}>
        ...
        <div
          style={{ marginLeft: "300px", marginRight: "60px" }}
